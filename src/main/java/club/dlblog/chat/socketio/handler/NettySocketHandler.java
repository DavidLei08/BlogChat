package club.dlblog.chat.socketio.handler;

import club.dlblog.chat.bean.SocketMessageBean;
import club.dlblog.chat.socketio.util.NettySocketUtil;
...
public class NettySocketHandler implements CommandLineRunner {
    ...
    public void onMessage(SocketIOClient client, AckRequest request, Object data) {
        ...
        NettySocketUtil.sendAll(JSONObject.parseObject(data.toString(),SocketMessageBean.class));
